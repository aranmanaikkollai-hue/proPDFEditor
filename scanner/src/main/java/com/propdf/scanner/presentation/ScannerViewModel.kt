...
class ScannerViewModel @Inject constructor(
    ...
    fun previewEdgeDetection(bitmap: Bitmap, onResult: (EdgeDetectionResult) -> Unit) {
        viewModelScope.launch {
            try {
                ...
                // Silently fail for preview - do not disrupt UX
            }
        }
    }
    ...
    fun toggleFlash() {
        ...
        val currentConfig = _cameraConfig.value
        _cameraConfig.value = currentConfig.copy(
    ...
    fun toggleAutoCapture() {
        val currentConfig = _cameraConfig.value
        _cameraConfig.value = currentConfig.copy(
            enableAutoCapture = !currentConfig.enableAutoCapture
        )
    }
