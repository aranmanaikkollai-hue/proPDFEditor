...
class ViewerActivity : AppCompatActivity() {
    ...
    private fun buildUI() {
        rootLayout = LinearLayout(this).apply {
            ...
            setBackgroundColor(Color.parseColor("#121212"))  // AI Studio dark
        }
        ...
        val topBar = LinearLayout(this).apply {
            ...
            setBackgroundColor(Color.parseColor("#1A1F36"))  // AI Studio navy header
        ...
        val seekRow = LinearLayout(this).apply {
            ...
            setBackgroundColor(Color.parseColor("#0F1117"))  // AI Studio deeper dark
    ...
    private fun buildSearchBar(): LinearLayout {
        val bar = LinearLayout(this).apply {
            ...
            setBackgroundColor(Color.parseColor("#1E1E2E"))  // AI Studio dark
            visibility = View.GONE
        }
        ...
        val et = EditText(this).apply {
            ...
            setBackgroundColor(Color.parseColor("#2D2D44"))  // AI Studio input
        ...
        val btnGo = Button(this).apply {
            ...
            textSize = 11f
            setTextColor(Color.WHITE)
            setBackgroundColor(Color.parseColor("#448AFF"))  // AI Studio accent
        ...
        tools.chunked(4).forEach { rowTools ->
            ...
            rowTools.forEach { t ->
                ...
                cell.addView(TextView(this).apply {
                    ...
                    textSize = 9.5f
                    gravity = Gravity.CENTER
                    setTextColor(Color.WHITE)  // White text on dark cell
    ...
    private fun showTextInputDialog() {
        ...
        val et = EditText(this).apply {
            ...
            textSize = 15f
            maxLines = 5
            setBackgroundColor(Color.parseColor("#1E1E2E"))  // AI Studio dark card
