...
class ViewerActivity : AppCompatActivity() {
    ...
    // --- SECTION B: FUNCTIONAL LOGIC ---

    /**
     * Builds the Search Bar - dark input with gradient GO button.
     * Reference: Find option HTML design.
     */
    ...
    /**
     * Premium Annotation Toolbar - 3 Layers: Settings Pill, Tool Sub-Menu, Group Nav.
     * Reference: Annotations_bottom + Annotations_grouping HTML designs.
     */
    private fun buildAnnotationToolbar(): LinearLayout {
        ...
        return LinearLayout(this).apply {
            ...
            // Layer 2: Tool Sub-Menu horizontal scroll
            ...
            groups.forEach { g ->
                ...
                addView(LinearLayout(this@ViewerActivity).apply {
                    ...
                    addView(ImageView(this@ViewerActivity).apply {
                        ...
                        colorFilter = PorterDuffColorFilter(
                            if (isActive) cActive else cInact,
    ...
    private fun buildAnnotToolCell(toolId: String): LinearLayout {
        ...
        val cCardOff = Color.parseColor("#2D2D2D")
        ...
        return LinearLayout(this).apply {
            ...
            addView(ImageView(this@ViewerActivity).apply {
                ...
                colorFilter = PorterDuffColorFilter(
                    if (isActive) cIconOn else cIconOff,
                    PorterDuff.Mode.SRC_IN
                )
    ...
    private fun runSearch() {
        // Search logic reads searchInput.text and populates searchResults
        updateSearchCounter()
    }
