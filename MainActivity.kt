...
class MainActivity : AppCompatActivity() {
    ...
    private fun buildUI() {
        ...
        val scroll = ScrollView(this).apply {
            ...
            scrollbars = android.view.View.SCROLLBARS_NONE
        }
    ...
    private fun renderCategories() {
        ...
        val cats = allFiles.groupBy { it.category }
        if (cats.isEmpty()) { emptyState.visibility = View.VISIBLE; return }
        ...
        cats.forEach { (cat, files) ->
            listContainer.addView(buildCategoryCard(cat, files))
        }
    }
    ...
    private fun showCreateCategoryDialog() {
        ...
        android.app.AlertDialog.Builder(this).setTitle("New Category").setView(et)
            .setPositiveButton("Create") { _, _ ->
                ...
                if (name.isNotEmpty()) toast("Category '$name' created. Move files to it by long-pressing a file.")
