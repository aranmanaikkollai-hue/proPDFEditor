...
import com.propdf.editor.ui.scanner.DocumentScannerActivity   // FIX: correct package path
...
class MainActivity : AppCompatActivity() {
    ...
    private fun sortedFiles(): List<RecentFileEntity> {
        val base = when (currentTab) {
            ...
            "cat_detail" -> allFileEntities.filter {
                it.category == tvSection.text.toString()
            }
        ...
        val sorted = when (sortMode) {
            ...
            else   -> base.sortedBy { it.lastOpenedAt }
        }
    ...
    private fun buildFileCardCompact(entity: RecentFileEntity): LinearLayout {
        ...
        return LinearLayout(this).apply {
            ...
            addView(TextView(this@MainActivity).apply {
                layoutParams = LinearLayout.LayoutParams(dp(44), dp(44))
                text = initial; gravity = Gravity.CENTER; textSize = 18f
                typeface = Typeface.DEFAULT_BOLD; setTextColor(Color.WHITE)
                background = GradientDrawable().apply {
                    setColor(Color.parseColor(DANGER)); cornerRadius = dp(8).toFloat()
                }
            })
            addView(TextView(this@MainActivity).apply {
                ...
                setTextColor(Color.parseColor(txt1())); maxLines = 2
                ellipsize = android.text.TextUtils.TruncateAt.END
            })
            addView(TextView(this@MainActivity).apply {
                text = sizeMb; textSize = 10f; setTextColor(Color.parseColor(txt2()))
            })
    ...
    private fun buildVaultCard(category: String, count: Int): LinearLayout {
        ...
        return LinearLayout(this).apply {
            ...
            addView(TextView(this@MainActivity).apply {
                ...
                text = "F"; gravity = Gravity.CENTER; textSize = 18f
    ...
    private fun showCreateFolderDialog() {
        ...
        AlertDialog.Builder(this).setTitle("New Folder").setView(et)
            .setPositiveButton("Create") { _, _ ->
                ...
                if (name.isNotEmpty()) {
                    val ex = prefs.getStringSet("user_categories", mutableSetOf())!!
                        .toMutableSet()
                    ex.add(name)
