    ...
    private fun refreshRecentList(files: List<RecentFileEntity>) {
        ...
        files.forEach { f ->
            ...
            val badgeText = TextView(this).apply {
                text = "PDF"; textSize = 11f; typeface = android.graphics.Typeface.DEFAULT_BOLD
            ...
            val btnDel = ImageButton(this).apply {
                ...
                setColorFilter(android.graphics.Color.parseColor("#BBBBBB"))
