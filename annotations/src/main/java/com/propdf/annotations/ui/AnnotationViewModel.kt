    ...
    fun initializeDocument(
        ...
        viewModelScope.launch {
            ...
            try {
                ...
                // Genuinely switching documents (the early-return above already handled the
                // same-document case): drop the previous document's layers/active-layer and
                // undo/redo stack before loading this document's own annotations, so neither
