...
abstract class SyncModule {
    ...
    companion object {
        ...
        // WorkManager provided by :editor's com.propdf.editor.di.WorkManagerModule
        // (the :app module used to duplicate this same binding under the identical
        // package/class name, which caused a Dagger duplicate-binding failure that
        // kapt reported only as "Could not load module <Error module>"; the
        // duplicate has since been removed from :app).
    }
}
