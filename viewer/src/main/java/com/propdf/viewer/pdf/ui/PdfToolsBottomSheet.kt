...
@AndroidEntryPoint
class PdfToolsBottomSheet @Inject constructor(
    private val viewModel: PdfToolsViewModel
    ...
    companion object {
        ...
        fun newInstance(sourceUri: Uri, pageCount: Int, viewModel: PdfToolsViewModel): PdfToolsBottomSheet {
            return PdfToolsBottomSheet(viewModel).apply {
