...
object PdfToolsModule {
    ...
    @Provides
    @ActivityScoped
    fun providePdfToolEngine(@ActivityContext context: Context): PdfToolEngine = PdfToolEngine(context)

    @Provides
    @ActivityScoped
    fun provideTempFileManager(@ActivityContext context: Context): TempFileManager = TempFileManager(context)
    ...
    ): PdfExportManager = PdfExportManager(context, engine, tempManager)
}
