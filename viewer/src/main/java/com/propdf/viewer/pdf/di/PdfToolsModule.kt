...
object PdfToolsModule {
    ...
    ): PdfToolEngine = PdfToolEngine(context)

    @Provides
    @ActivityScoped
    fun provideTempFileManager(
        @ActivityContext context: Context
    ): TempFileManager = TempFileManager(context)
    ...
    @Provides
    @ActivityScoped
    fun providePdfWorkScheduler(
        @ActivityContext context: Context
    ): PdfWorkScheduler = PdfWorkScheduler(context)
}
