...
/**
* Export annotations by flattening them into the PDF.
* Creates a new PDF with annotations rendered as native PDF content.
*/
...
/**
* Flatten annotations onto a PDF and save to output file.
* @param sourcePdfUri URI of the original PDF
* @param annotationManager Manager containing annotations
...
// Render annotations to bitmap at high resolution
...
// Convert to PDF image and overlay
...
/**
* Export annotations as a separate PDF layer (overlay PDF).
*/
