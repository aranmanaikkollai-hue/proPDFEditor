...
/**
* Hardware-accelerated annotation renderer.
* Renders all annotation types onto a canvas with proper scaling.
*/
class AnnotationRenderer {
    ...
    private fun renderTextMarkup(
        ...
        val rects = if (annotation.quads.isNotEmpty()) annotation.quads else listOf(annotation.bounds)
    ...
    private fun renderShape(
        ...
        val left = annotation.bounds.left * pageWidth
        val top = annotation.bounds.top * pageHeight
        val right = annotation.bounds.right * pageWidth
        val bottom = annotation.bounds.bottom * pageHeight
