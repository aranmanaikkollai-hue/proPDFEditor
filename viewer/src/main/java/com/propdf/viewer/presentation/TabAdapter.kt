...
class TabAdapter(
    ...
    override fun onBindViewHolder(holder: TabViewHolder, position: Int) {
        holder.bind(getItem(position), position == activeIndex, position, currentList.size)
    }
    ...
    class TabViewHolder(
        ...
        private val tabName: TextView = itemView.findViewById(R.id.tab_title)
        ...
        fun bind(tab: PdfTab, isActive: Boolean, position: Int, tabCount: Int) {
            ...
            closeButton.isVisible = tabCount > 1
        }
    }
