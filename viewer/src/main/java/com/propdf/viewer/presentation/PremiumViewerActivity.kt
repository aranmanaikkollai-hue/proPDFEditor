...
annotationToolbar.translationY = -resources.getDimensionPixelSize(R.dimen.margin_large).toFloat()
...
annotationFlattener.flattenAnnotations(file, outFile, annotationManager.annotations.value)
