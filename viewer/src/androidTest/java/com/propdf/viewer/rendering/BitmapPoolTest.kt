 ...
 * Verifies memory management, recycling, and thread safety.
 */
...
class BitmapPoolTest {
    ...
    fun setup() {
        ...
        bitmapPool.initialize(4L * 1024 * 1024 * 1024) // 4GB simulated
    }
    ...
    fun testBitmapReuse() = runBlocking {
        ...
        // Should reuse the same bitmap instance
    ...
    fun testPoolTrimming() = runBlocking {
        ...
        val stats = bitmapPool.getStats()
        // Pool should have trimmed to stay within budget
    ...
    fun testConcurrentAccess() = runBlocking {
        ...
        // All bitmaps should be returned to pool or recycled
        val stats = bitmapPool.getStats()
    ...
    fun testEmergencyTrim() = runBlocking {
        ...
        // Pool should handle this without OOM
        val stats = bitmapPool.getStats()
