...
// Uses a fresh PDFTextStripper per page to avoid state contamination
(rule #15).
...
**TextReflowActivity.kt**

Scrollable single-column reading mode. Font size A-/A+, inline search
with highlight, copy all. setTextIsSelectable(true) method call (rule
#9). FileHelper used as object singleton (FIX: no \@Inject).
