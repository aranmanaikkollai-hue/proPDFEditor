...
// 1. Added explicit import androidx.camera.core.ImageProxy (was missing
-> lines 52,68,89 errors)
...
// 3. EdgeOverlayView and ScanSaveActivity are now resolved via
codemagic.yaml cp commands
...
// Rule #10: FrameLayout.LayoutParams(width, height) only -- no weight
float

// Rule #14: isVerticalScrollBarEnabled = false (not scrollbars
property)
