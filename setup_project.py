...
Called by codemagic.yaml during the build before Gradle runs.
"""
...
<resources>
    ...
    <style name="Theme.ProPDF.ActionBar" parent="Theme.MaterialComponents.DayNight">
        <item name="colorPrimary">@color/primary</item>
        <item name="colorPrimaryDark">@color/primary_dark</item>
    </style>
</resources>
