...
class LanShareServer @Inject constructor(
    ...
    private fun serveFile(token: String): Response {
        val uri = sharedFiles[token] ?: return newFixedLengthResponse(
        ...
        return try {
            ...
            newFixedLengthResponse(Response.Status.OK, "application/pdf", fis, size)
        } catch (e: Exception) {
