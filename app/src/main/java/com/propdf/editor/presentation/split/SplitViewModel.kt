...
class SplitViewModel @Inject constructor(
    ...
    private val _pageRanges = MutableStateFlow<List<IntRange>>(emptyList())
    val pageRanges: StateFlow<List<IntRange>> = _pageRanges
