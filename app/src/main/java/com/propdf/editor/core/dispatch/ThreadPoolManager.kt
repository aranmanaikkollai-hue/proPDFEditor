...
object ThreadPoolManager {
    ...
    private val renderExecutor: ThreadPoolExecutor by lazy {
        ThreadPoolExecutor(
            ...
            ThreadFactory { r ->
                Thread(r, "pdf-render-${it.incrementAndGet()}").apply {
                    isDaemon = true
    ...
    private val ioExecutor: ThreadPoolExecutor by lazy {
        ThreadPoolExecutor(
            ...
            ThreadFactory { r ->
                Thread(r, "pdf-io-${it.incrementAndGet()}").apply {
                    isDaemon = true
    ...
    private val backgroundExecutor: ThreadPoolExecutor by lazy {
        ThreadPoolExecutor(
            ...
            ThreadFactory { r ->
                Thread(r, "pdf-bg-${it.incrementAndGet()}").apply {
                    isDaemon = true
    ...
    private val cacheExecutor: ThreadPoolExecutor by lazy {
        ThreadPoolExecutor(
            ...
            ThreadFactory { r ->
                Thread(r, "pdf-cache-${it.incrementAndGet()}").apply {
                    isDaemon = true
                    priority = Thread.MIN_PRIORITY
                }
            }
