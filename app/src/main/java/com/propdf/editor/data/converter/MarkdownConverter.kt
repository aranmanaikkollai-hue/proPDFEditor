        ...
        try {
            ...
            document.accept(object : AbstractVisitor() {
                override fun visit(heading: Heading) {
                    ...
                    updateProgress(processedCount, nodeCount, onProgress)
                }
                ...
                override fun visit(thematicBreak: ThematicBreak) {
                    processedCount++
                    val line = LineSeparator(com.itextpdf.layout.borders.SolidBorder(
                        com.itextpdf.kernel.colors.ColorConstants.GRAY, 1f
                    ))
