// FILE: ScanSaveActivity.kt
// FLAT REPO ROOT -- codemagic.yaml copies to:
// app/src/main/java/com/propdf/editor/ui/scanner/ScanSaveActivity.kt
//
// FEATURE: Post-scan review screen
//   - Shows thumbnails of captured pages in horizontal RecyclerView-lite scroll
//   - Name field for PDF output
//   - Quality selector: Low / Medium / High
//   - Category selector (uses CategoryManager subcategory support)
//   - Saves via PdfOperationsManager.imagesToPdf (iText, rule-compliant)
//
// RULES OBEYED:
//   - PdfDocument NOT Closeable: already handled inside PdfOperationsManager  (rule #1)
//   - isTextSelectable = true -> setTextIsSelectable(true)                    (rule #9)
//   - scrollbars via isHorizontalScrollBarEnabled = false                     (rule #14)
...
class ScanSaveActivity : AppCompatActivity() {
    ...
    private fun buildUI() {
        ...
        val allCats = listOf("General") + CategoryManager.getAllCategories(this)
        ...
        progressBar = ProgressBar(this).apply {
            ...
            layoutParams = LinearLayout.LayoutParams(-2, dp(36)).apply { gravity = Gravity.CENTER }
        }
    ...
    private fun label(text: String) = TextView(this).apply {
        ...
        setTextColor(Color.parseColor("#444444")); typeface = Typeface.DEFAULT_BOLD
    ...
    private fun savePdf() {
        ...
        val allCats  = listOf("General") + CategoryManager.getAllCategories(this)
        val category = allCats.getOrElse(spinnerCategory.selectedItemPosition) { "General" }
        ...
        lifecycleScope.launch {
            ...
            pdfOps.imagesToPdf(files, outFile).onSuccess { pdf ->
                ...
                // Back to home
                startActivity(Intent(this@ScanSaveActivity, MainActivity::class.java).apply {
                ...
                Toast.makeText(this@ScanSaveActivity, "Save failed: ${it.message}", Toast.LENGTH_LONG).show()
            }
        }
    }
