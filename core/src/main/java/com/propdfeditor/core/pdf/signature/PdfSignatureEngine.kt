...
class PdfSignatureEngine @Inject constructor(
    ...
    suspend fun applyDigitalSignature(
        ...
        runCatching {
            ...
            val signerProperties = SignerProperties().apply {
                setPageRect(
                    Rectangle(
                        rect.left,
                        rect.top,
                ...
                setFieldName("$SIGNATURE_FIELD_NAME_PREFIX${System.currentTimeMillis()}")
                setReason(reason)
            ...
            if (signatureBitmap != null) {
                ...
                signerProperties.setSignatureGraphic(imageData)
                signerProperties.setRenderingMode(PdfSigner.RenderingMode.GRAPHIC)
            }
            ...
            val signature = PrivateKeySignature(privateKey, hashAlgorithm, BouncyCastleDigest())
