    ...
    override suspend fun getDownloadedModels(): AppResult<List<OcrLanguage>> = withContext(dispatchers.io) {
        try {
            ...
            val allModels = listOf(
                OcrLanguage.HINDI to DevanagariTextRecognizerOptions.Builder().build(),
                OcrLanguage.JAPANESE to JapaneseTextRecognizerOptions.Builder().build(),
                OcrLanguage.KOREAN to KoreanTextRecognizerOptions.Builder().build(),
                OcrLanguage.CHINESE_SIMPLIFIED to ChineseTextRecognizerOptions.Builder().build()
            )
...
")
    ...
    private fun getModelForLanguage(language: OcrLanguage): com.google.mlkit.common.model.RemoteModel? {
        return when (language.script) {
            Script.DEVANAGARI -> DevanagariTextRecognizerOptions.Builder().build()
