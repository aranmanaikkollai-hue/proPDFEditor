...
class OcrWorker @AssistedInject constructor(
    ...
    override suspend fun doWork(): Result {
        ...
        try {
            ...
            val format = OcrOutputFormat.valueOf(outputFormat)
            val config = OcrConfig(languages = languages)
            ...
            val outputFileName = "ocr_result_${System.currentTimeMillis()}.${getExtension(format)}"
