...
class EdgeOverlayView @JvmOverloads constructor(
    ...
    // The detected quad corners in VIEW coordinates (scaled from detection coords)
    private var quad: EdgeDetectionProcessor.Quad? = null

    // Source image dimensions used during detection (for scaling to view coords)
