...
// 1. Removed PdfStream.use{} -- PdfStream is NOT Closeable (violates
rule #1 variant)

// 2. Removed PdfTokenizer / RandomAccessFileOrArray (iText Community
API issues)

// 3. Removed PdfTextExtractor imports that caused unresolved references

// 4. Simplified to always-visual redaction -- black box painted via
newContentStreamAfter()

// This is correct behaviour: visual redaction hides content from
readers.

// For metadata-level text removal, iText RUPS (commercial) or a
