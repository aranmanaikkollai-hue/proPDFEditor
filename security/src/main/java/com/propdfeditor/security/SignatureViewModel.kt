...
class SignatureViewModel @Inject constructor(
    ...
    fun getSignatureBitmap(signature: SignatureEntity): Bitmap? =
        signatureRepository.getSignatureBitmap(signature)

    fun isCertificateValid(certificate: CertificateEntity): Boolean =
        certificateRepository.isCertificateValid(certificate)

    fun getDaysUntilExpiry(certificate: CertificateEntity): Int? =
        certificateRepository.getDaysUntilExpiry(certificate)
